...
class FormatCreator {
 ...
 public static function ExcelCreate($data){
    ...
    //set a worksheet’s column visibility
...
//$objPHPExcel->getActiveSheet()->getHeaderFooter()->setOddHeader('Please treat this document as confidential!');
//$objPHPExcel->getActiveSheet()->getHeaderFooter()->setOddFooter('l' . $objPHPExcel->getProperties()->getTitle() . 'll');
