...
public static $Permissions = array(
    ...
    'labs'                  => array(
                                        ...
                                        'PUT' => array('ΔΙΕΥΘΥΝΤΗΣ','ΥΠΕΥΘΥΝΟΣ-ΔΙΑΤΑΞΗΣ','ΤΟΜΕΑΡΧΗΣ'),
                                        'DELETE' => array('ΔΙΕΥΘΥΝΤΗΣ','ΤΟΜΕΑΡΧΗΣ'),
                                        ) ,
    'lab_aquisition_sources'=> array(
                                        'GET' => array('ΚΕΠΛΗΝΕΤ','ΔΙΕΥΘΥΝΤΗΣ','ΥΠΕΥΘΥΝΟΣ-ΔΙΑΤΑΞΗΣ','ΠΣΔ','ΥΠΕΠΘ','ΤΟΜΕΑΡΧΗΣ'),
                                        'POST' => array('ΔΙΕΥΘΥΝΤΗΣ','ΥΠΕΥΘΥΝΟΣ-ΔΙΑΤΑΞΗΣ','ΤΟΜΕΑΡΧΗΣ'),
                                        'PUT' => array('ΔΙΕΥΘΥΝΤΗΣ','ΥΠΕΥΘΥΝΟΣ-ΔΙΑΤΑΞΗΣ','ΤΟΜΕΑΡΧΗΣ'),
                                        'DELETE' => array('ΔΙΕΥΘΥΝΤΗΣ','ΥΠΕΥΘΥΝΟΣ-ΔΙΑΤΑΞΗΣ','ΤΟΜΕΑΡΧΗΣ'),
                                        ) ,
...
///**
// * 
// * Check user["title"] attribute
// * and get max user role with ranking system
// * 
