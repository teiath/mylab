...
require_once('classes/models/Workers.class.php');

class WorkersExt extends Workers
{
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getWorkerId()] = $obj->getRegistryNo(); 
            self::$objsArray[$obj->getWorkerId()] = $obj; 
        }
    }
    ...
    public static function findByFilterWithLimit(PDO $db, $filter, $and=true, $sort=null, $start=null, $count=null) 
    {
        ...
        if (isset($start) && isset($count) && ($count <> Parameters::AllPageSize))
    ...
    {
        self::$rowsArray[$this->getWorkerId()] = $this->getRegistryNo(); 
        self::$objsArray[$this->getWorkerId()] = $this; 
    }
