...
require_once('classes/models/RelationTypes.class.php');

class RelationTypesExt extends RelationTypes{
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getRelationTypeId()] = $obj->getName(); 
            self::$objsArray[$obj->getRelationTypeId()] = $obj; 
        }
    }
    ...
    {
        self::$rowsArray[$this->getRelationTypeId()] = $this->getName(); 
        self::$objsArray[$this->getRelationTypeId()] = $this; 
    }
