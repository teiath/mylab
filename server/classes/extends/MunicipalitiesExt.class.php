...
require_once('classes/models/Municipalities.class.php');

class MunicipalitiesExt extends Municipalities
{
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getMunicipalityId()] = $obj->getName(); 
            self::$objsArray[$obj->getMunicipalityId()] = $obj; 
        }
    }
    ...
    {
        self::$rowsArray[$this->getMunicipalityId()] = $this->getName(); 
        self::$objsArray[$this->getMunicipalityId()] = $this; 
    }
