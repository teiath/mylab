...
require_once('classes/models/SchoolUnitWorkers.class.php');

class SchoolUnitWorkersExt extends SchoolUnitWorkers {
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getSchoolUnitWorkerId()] = $obj->getSchoolUnitWorkerId(); 
            self::$objsArray[$obj->getSchoolUnitWorkerId()] = $obj;
        }
    }
    ...
    {
        self::$rowsArray[$this->getSchoolUnitWorkerId()] = $this->getSchoolUnitWorkerId(); 
        self::$objsArray[$this->getSchoolUnitWorkerId()] = $this;
    }
        /**
