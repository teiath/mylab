...
require_once('classes/models/EducationLevels.class.php');

class EducationLevelsExt extends EducationLevels
{
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getEducationLevelId()] = $obj->getName(); 
            self::$objsArray[$obj->getEducationLevelId()] = $obj; 
        }
    }
    ...
    {
        self::$rowsArray[$this->getEducationLevelId()] = $this->getName(); 
        self::$objsArray[$this->getEducationLevelId()] = $this; 
    }
