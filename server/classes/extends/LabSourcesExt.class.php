...
require_once('classes/models/LabSources.class.php');

class LabSourcesExt extends LabSources
{
    private $rowsArray ;
    private $objsArray ;
     ...
     *
     * example results :
     *[rowsArray:LabSourcesExt:private] => Array 
     *      ( 
     *          [2] => excell_sepeyh 
     *          [3] => excell_troxilata 
     *          [1] => web 
     *      )
     * 
     * @param int $rowId Id of lab_source
    ...
    *
    * example results :
    *    [objsArray:LabSourcesExt:private] => Array 
    * ( 
    *   [2] => LabSources Object 
    *   ( 
    *       [labSourceId:LabSources:private] => 2 
    *       [name:LabSources:private] => excell_sepeyh 
    *       [oldInstance:Db2PhpEntityBase:private] => 
    * ) 
    *   [3] => LabSources Object 
    *   ( 
    *       [labSourceId:LabSources:private] => 3 
    *       [name:LabSources:private] => excell_troxilata 
    *       [oldInstance:Db2PhpEntityBase:private] => 
    *   ) 
    * [1] => LabSources Object 
    *   ( 
    *       [labSourceId:LabSources:private] => 1 
    *       [name:LabSources:private] => web 
    *       [oldInstance:Db2PhpEntityBase:private] => 
    *   ) 
    * )
    * 
    ...
    */        
     ...
     *
     * Create rowsArray array with the lab_source_id as index and the lab_source name as value.
     * Create objsArray array with the lab_source_id as index and the value as value.  
     * 
     * @param PDO $db
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getLabSourceId()] = $obj->getName(); 
            $this->objsArray[$obj->getLabSourceId()] = $obj; 
        }
    }
     ...
     *
     * @param string $name name of lab_source
     * @return array
     */ 
     ...
     * 
     * Will return matched rows as an array of LabSources instances with limit.
     *
     ...
     * or a array of DFC instances.
     * 
     * Will return an array of LabSources which contain count value at AquisitionSourceId field.
     *
     * @param PDO $db a PDO Database instance
     * @param array $filter array of DFC instances defining the conditions
     * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
