...
require_once('classes/models/Prefectures.class.php');

class PrefecturesExt extends Prefectures
{
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getPrefectureId()] = $obj->getName(); 
            self::$objsArray[$obj->getPrefectureId()] = $obj; 
        }
    }
    ...
    {
        self::$rowsArray[$this->getPrefectureId()] = $this->getName(); 
        self::$objsArray[$this->getPrefectureId()] = $this; 
    }
