...
require_once('classes/models/CircuitTypes.class.php');

class CircuitTypesExt extends CircuitTypes{
    ...
    */   
    ...
    public function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            $this->rowsArray[$obj->getCircuitTypeId()] = $obj->getName(); 
            $this->objsArray[$obj->getCircuitTypeId()] = $obj; 
        }
    }
