...
require_once('classes/models/LabRelations.class.php');

class LabRelationsExt extends LabRelations {
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getLabRelationId()] = $obj->getLabRelationId(); 
            self::$objsArray[$obj->getLabRelationId()] = $obj;
        }
    }
    ...
    {
        self::$rowsArray[$this->getLabRelationId()] = $this->getLabRelationId(); 
        self::$objsArray[$this->getLabRelationId()] = $this;
    }
        /**
