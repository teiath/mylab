...
require_once('classes/models/WorkerSpecializations.class.php');

class WorkerSpecializationsExt extends WorkerSpecializations {
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getWorkerSpecializationId()] = $obj->getName(); 
            self::$objsArray[$obj->getWorkerSpecializationId()] = $obj; 
        }
    }
    ...
    {
        self::$rowsArray[$this->getWorkerSpecializationId()] = $this->getName(); 
        self::$objsArray[$this->getWorkerSpecializationId()] = $this; 
    }
