...
require_once('classes/models/EquipmentTypes.class.php');

class EquipmentTypesExt extends EquipmentTypes{
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getEquipmentTypeId()] = $obj->getName(); 
            self::$objsArray[$obj->getEquipmentTypeId()] = $obj; 
        }
    }
    ...
    {
        self::$rowsArray[$this->getEquipmentTypeId()] = $this->getName(); 
        self::$objsArray[$this->getEquipmentTypeId()] = $this; 
    }
