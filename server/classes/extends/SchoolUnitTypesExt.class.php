...
require_once('classes/models/SchoolUnitTypes.class.php');

class SchoolUnitTypesExt extends SchoolUnitTypes
{
    ...
    public static function getAll(PDO $db, $filter, $and=true, $sort=null) 
    {
        ...
        foreach($objs as $obj)
        {
            self::$rowsArray[$obj->getSchoolUnitTypeId()] = $obj->getName(); 
            self::$objsArray[$obj->getSchoolUnitTypeId()] = $obj; 
        }
    }
    ...
    {
        self::$rowsArray[$this->getSchoolUnitTypeId()] = $this->getName(); 
        self::$objsArray[$this->getSchoolUnitTypeId()] = $this; 
    }
