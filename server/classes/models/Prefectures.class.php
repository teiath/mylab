...
class Prefectures extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	...
	/**
	 * set value for name Το όνομα του νομού.
	 *
	...
	/**
	 * get value for name Το όνομα του νομού.
	 *
	 * type:VARCHAR,size:255,default:null,nullable
	 *
	 * @return mixed
	...
	/**
	 * Fetch SchoolUnits's which this Prefectures references.
	 * `prefectures`.`prefecture_id` -> `school_units`.`prefecture_id`
	 *
	 * @param PDO $db a PDO Database instance
	 * @param array $sort array of DSC instances
	 * @return SchoolUnits[]
	...
	public function fetchSchoolUnitsCollection(PDO $db, $sort=null) {
		$filter=array(SchoolUnits::FIELD_PREFECTURE_ID=>$this->getPrefectureId());
