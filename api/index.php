...
<br>
<hr>
<br><b>Γενικές Πληροφορίες</b></br>

<br> Οι συναρτήσεις επιστρέφουν αποτελέσματα σύμφωνα με τις παραμέτρους που έγινε η κάθε κλήση.
<br> Τα αποτελέσματα είναι ταξινομημένα κατά αύξουσα φορά.</br>
 
<br>Στον πίνακα <a>Parameters</a> εμφανίζονται όλοι οι παράμετροι με τους οποίους μπορεί να γίνει η κλήση
<br>Όλοι οι παράμετροι είναι προαιρετικοί εκτός από αυτές που έχουν χαρακτηριστεί ως υποχρεωτικοί
<br>Οι παράμετροι μπορούν να χρησιμοποιηθούν με οποιαδήποτε σειρά</br>
 
<br>Στον πίνακα <a>Model Schema</a> εμφανίζονται οι μεταβλητές που επιστρέφει η συνάρτηση
<br>Όλες οι μεταβλητές επιστρέφονται σε ένα πίνακα σε JSON μορφή
<br>Η μεταβλητή data είναι ο πίνακας με τα δεδομένα.</br>
 
<br>Στον πίνακα <a>Response Body</a> εμφανίζονται τα αποτελεσματα της κλήσης της συνάρτησης.</br>
 
<br>Στον πίνακα <a>Response Messages</a> εμφανίζονται τα Μηνύματα Σφαλμάτων που μπορεί να προκύψουν κατά την κλήση της συνάρτησης</br>
...
<br>Η τιμή της παραμέτρου μπορεί να είναι : integer</br>
