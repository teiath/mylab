...
* basePath=BASE_PATH,
* resourcePath="/worker_positions",
* description="Λεξικό : Θέσεις Εργασίας Εργαζόμενων",
* produces="['application/json']",
* @SWG\Api(
*   path="/worker_positions",
*   @SWG\Operation(
*                   method="GET",
*                   summary="Αναζήτηση σε Θέσεις Εργασίας Εργαζόμενων",
*                   notes="Επιστρέφει τις Θέσεις Εργασίας Εργαζόμενων",
*                   type="getWorkerPositions",
*                   nickname="GetWorkerPositions",
*   @SWG\Parameter(
*                   name="worker_position_id",
*                   description="ID Θέσης Εργασίας Εργαζόμενου [notNull]",
*                   required=false,
...
*   @SWG\Parameter(
*                   name="name",
*                   description="Όνομα Θέσης Εργασίας Εργαζόμενου (Συνδυάζεται με την παράμετρο searchtype)",
*                   required=false,
...
*   @SWG\ResponseMessage(code=ExceptionCodes::InvalidWorkerPositionIDType, message=ExceptionMessages::InvalidWorkerPositionIDType),
*   @SWG\ResponseMessage(code=ExceptionCodes::InvalidWorkerPositionNameType, message=ExceptionMessages::InvalidWorkerPositionNameType),
...
* @SWG\Property(name="data",type="array",description="Ο Πίνακας με το λεξικό",items="$ref:WorkerPosition"),
...
* @SWG\Model(
* id="WorkerPosition",
* description="Επιστρέφει ένα πίνακα σε JSON μορφή με πεδία του πίνακα worker_positions : ",
* @SWG\Property(name="worker_position_id",type="integer",description="Ο Κωδικός ID της Θέσης Εργασίας Εργαζόμενου"),
* @SWG\Property(name="name",type="string",description="Το Όνομα της Θέσης Εργασίας Εργαζόμενου")
* )
* 
*/
