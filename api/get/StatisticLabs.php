...
* basePath=BASE_PATH,
* resourcePath="/statistic_labs",
* description="Στατιστικά Διατάξεων Η/Υ",
* produces="['application/json']",
* @SWG\Api(
*   path="/statistic_labs",
*   @SWG\Operation(
*                   method="GET",
*                   summary="Στατιστικά για τις Διατάξεις Η/Υ",
*                   notes="Επιστρέφει Στατιστικά για τις Διατάξεις Η/Υ.Αφορά μόνο υποβεβλημένες Διατάξεις Η/Υ.",
*                   type="getStatisticLabs",
*                   nickname="GetStatisticLabs",
* 
...
* @SWG\Property(name="total",type="integer",description="Το πλήθος των Διατάξεων Η/Υ"),
...
//======================================================================================================================
        ...
        if ( Validator::Exists('aquisition_source', $params) )
        {
            ...
            $filter[] = Filters::BasicFilter( $aquisition_source, $table_name, $table_column_id, $table_column_name, $filter_validators, 
...
//======================================================================================================================
        ...
        if ( Validator::Exists('equipment_type', $params) )
        {
            ...
            $filter[] = Filters::BasicFilter( $equipment_type, $table_name, $table_column_id, $table_column_name, $filter_validators, 
...
//======================================================================================================================
        ...
        if ( Validator::Exists('lab_worker', $params) )
        {
            ...
            $filter[] = Filters::BasicFilter( $lab_worker, $table_name, $table_column_id, $table_column_name, $filter_validators, 
