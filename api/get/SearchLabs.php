...
function SearchLabs ( $lab_id, $name, $special_name, $creation_date, $operational_rating, $technological_rating,
...
//======================================================================================================================
        ...
        if ( Validator::isExists('orderby') )
        {
            $columns = array(
                "lab_id",
                "name", "operational_rating", "technological_rating",
                "lab_type_id", "lab_type",
                "school_unit_id", "school_unit",
...
//======================================================================================================================
        ...
        foreach ($array_labs as $lab)
        {
            $data = array(
                ...
                "school_unit_state"         => $lab["school_unit_state_name"],         
